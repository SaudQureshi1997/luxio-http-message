...
class Response extends Message implements ResponseInterface
{
    ...
    protected const ERROR_INVALID_STATUS = 'ERROR: invalid status code';
    ...
    public function withStatus($statusCode, $reasonPhrase = '')
    {
        if (!isset(self::STATUS_CODES[$statusCode])) {
            throw new InvalidArgumentException(self::ERROR_INVALID_STATUS);
        }
    ...
    public function getReasonPhrase()
    {
        return $this->status['reason']
            ?? self::STATUS_CODES[$this->status['code']]
            ?? '';
    }
}
